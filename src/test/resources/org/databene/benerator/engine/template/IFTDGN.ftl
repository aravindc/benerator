...
HAN+L'
TDT+20+${iftdgn.vessel_voy_dir_vn_E_8028_10_02}${iftdgn.vessel_voy_dir_d_E_8028_10_02}+1+${iftdgn.vessel_id_C_C001_10_04}++++${iftdgn.transport_id_C_C222_10_08}'
RFF+${iftdgn.ref_C_C506_12_01}'
LOC+153+${iftdgn.pol_ot_C_C517_14_02}:139:6'
DTM+132:130822:101'
DTM+133:130823:101'
LOC+61+${iftdgn.npoc_ot_C_C517_14_02}:139:6'
EQD+CN+${iftdgn.equBbkRorItem_ot_C_C237_22_02}+${iftdgn.equipment_size_and_type_C_C224_22_03}'
MEA+WT+AAN+TNE:26'
...
GID+${gid_index+1}+${gid.no_and_type_of_packages_C_C213_42_02}'
DGS+IMD+3+1263:24C+24:CEL+3+F-E'
FTX+AAD+++PAINT'
MEA+WT+AAL+KGM:21113'
MEA+WT+G+KGM:0'
RFF+APN:${gid.dgrNo_ot_C_C506_53_01}'
SGP+${iftdgn.equBbkRorItem_ot_C_C237_22_02}'
LOC+147+${gid.stowagePosition_ot_C_C517_56_02}'
MEA+WT+AAL+KGM:21113'
MEA+WT+G+KGM:0'
</#list>
</#list>
