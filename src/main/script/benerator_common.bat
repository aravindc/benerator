...
:setLocalClassPath
set LOCALCLASSPATH=.;%BENERATOR_HOME%\bin;%BENERATOR_HOME%\databene-benerator-0.3.04.jar;%BENERATOR_HOME%\lib\databene-webdecs-0.2.04.jar;%BENERATOR_HOME%\lib\databene-commons-0.2.04.jar;%BENERATOR_HOME%\lib\commons-logging-1.0.4.jar
