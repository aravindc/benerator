...
COMMENT ON TABLE db_category IS 'Hierarchy of product categories';
...
COMMENT ON TABLE db_product IS 'products';
...
COMMENT ON TABLE db_role IS 'roles of the shop users';
--
-- db_user
--
...
COMMENT ON TABLE db_user IS 'shop users';
...
COMMENT ON TABLE db_customer IS 'users of type ''customer''';
...
COMMENT ON TABLE db_order IS 'product orders';
...
COMMENT ON TABLE db_order_item IS 'order items';
