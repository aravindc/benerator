...
-- db_user
--
CREATE SEQUENCE db_user_id_seq START WITH 1000;
CREATE TABLE db_user (
  id       integer     NOT NULL DEFAULT nextval('db_user_id_seq'),
  name     varchar(30) NOT NULL,
...
ALTER SEQUENCE db_user_id_seq OWNED BY db_user.id;
--
-- db_customer
--
...
-- db_order
--
CREATE SEQUENCE db_order_id_seq START WITH 1000;
CREATE TABLE db_order (
  id          integer   NOT NULL DEFAULT nextval('db_order_id_seq'),
...
ALTER SEQUENCE db_order_id_seq OWNED BY db_order.id;
--
-- db_order_item
--
CREATE SEQUENCE db_order_item_id_seq START WITH 1000;
CREATE TABLE db_order_item (
  id              integer      NOT NULL DEFAULT nextval('db_order_item_id_seq'),
...
ALTER SEQUENCE db_order_item_id_seq OWNED BY db_order_item.id;
COMMIT;